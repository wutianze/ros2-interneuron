...
#include "picas_msgs/msg/detail/u_time__rosidl_typesupport_fastrtps_c.h"
...
using _UTime__ros_msg_type = picas_msgs__msg__UTime;
...
static uint32_t _UTime__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_picas_msgs__msg__UTime(
...
static size_t _UTime__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_picas_msgs__msg__UTime(
