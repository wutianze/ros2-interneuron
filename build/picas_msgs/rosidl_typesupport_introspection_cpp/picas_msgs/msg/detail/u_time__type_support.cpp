...
{
  new (message_memory) picas_msgs::msg::UTime(_init);
}

void UTime_fini_function(void * message_memory)
{
  auto typed_message = static_cast<picas_msgs::msg::UTime *>(message_memory);
  typed_message->~UTime();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UTime_message_member_array[2] = {
  {
    ...
    offsetof(picas_msgs::msg::UTime, sec),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(picas_msgs::msg::UTime, usec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::picas_msgs::msg::rosidl_typesupport_introspection_cpp::UTime_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, picas_msgs, msg, UTime)() {
  return &::picas_msgs::msg::rosidl_typesupport_introspection_cpp::UTime_message_type_support_handle;
}
