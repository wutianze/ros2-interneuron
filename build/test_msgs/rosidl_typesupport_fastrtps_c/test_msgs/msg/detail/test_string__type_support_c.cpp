...
#include "test_msgs/msg/detail/test_string__rosidl_typesupport_fastrtps_c.h"
...
#include "test_msgs/msg/detail/u_time__functions.h"  // stamp

// forward declare type support functions
size_t get_serialized_size_test_msgs__msg__UTime(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_test_msgs__msg__UTime(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, msg, UTime)();


using _TestString__ros_msg_type = test_msgs__msg__TestString;
  ...
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, test_msgs, msg, UTime
      )()->data);
...
size_t get_serialized_size_test_msgs__msg__TestString(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TestString__ros_msg_type * ros_message = static_cast<const _TestString__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_test_msgs__msg__UTime(
...
static uint32_t _TestString__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_msgs__msg__TestString(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_msgs
size_t max_serialized_size_test_msgs__msg__TestString(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: stamp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_test_msgs__msg__UTime(
...
static size_t _TestString__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_msgs__msg__TestString(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_msgs, msg, TestString)() {
