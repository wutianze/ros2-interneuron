...
bool test_msgs__msg__u_time__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._u_time.UTime", full_classname_dest, 27) == 0);
  }
  test_msgs__msg__UTime * ros_message = _ros_message;
  {  // sec
...
PyObject * test_msgs__msg__u_time__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_msgs.msg._u_time");
