...
#include "test_msgs/msg/detail/u_time__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const test_msgs::msg::UTime *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_msgs::msg::UTime *>(
    untyped_ros_message);
...
{
  return &test_msgs::msg::typesupport_fastrtps_cpp::_UTime__handle;
}
