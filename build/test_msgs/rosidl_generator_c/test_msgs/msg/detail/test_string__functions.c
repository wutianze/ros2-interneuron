...
test_msgs__msg__TestString__create()
{
  ...
  test_msgs__msg__TestString * msg = (test_msgs__msg__TestString *)allocator.allocate(sizeof(test_msgs__msg__TestString), allocator.state);
  if (!msg) {
    return NULL;
  }
...
test_msgs__msg__TestString__Sequence__init(test_msgs__msg__TestString__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (test_msgs__msg__TestString *)allocator.zero_allocate(size, sizeof(test_msgs__msg__TestString), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_msgs__msg__TestString__Sequence * array = (test_msgs__msg__TestString__Sequence *)allocator.allocate(sizeof(test_msgs__msg__TestString__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  test_msgs__msg__TestString__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    test_msgs__msg__TestString * data =
      (test_msgs__msg__TestString *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_msgs__msg__TestString__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          test_msgs__msg__TestString__fini(&output->data[i]);
        }
        return false;
      }
    }
